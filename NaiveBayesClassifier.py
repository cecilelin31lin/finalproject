...
Gossiping_dir = "Gossiping/May 27/"
pcr1 = PlaintextCorpusReader(root=Gossiping_dir, fileids=".*\.txt") 
#.*\ 是所有檔案的意思

c = "Gossiping"
Gossiping_documents = [(pcr1.words(fileid),c) for fileid in pcr1.fileids()]
#print(Gossiping_documents[:9])

C_Chat_dir = "C_Chat/Sat May 15/"
pcr2 = PlaintextCorpusReader(root=C_Chat_dir, fileids=".*\.txt")

c = "C_Chat"
C_Chat_documents = [(pcr2.words(fileid),c) for fileid in pcr2.fileids()]
...
documents = Gossiping_documents + C_Chat_documents 
